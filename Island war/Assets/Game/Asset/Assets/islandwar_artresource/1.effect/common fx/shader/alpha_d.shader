Shader "YY/Alpha_D" {
	Properties {
		[HDR] _FrontColor ("FrontColor", Vector) = (1,1,1,1)
		[HDR] _BackColor ("BackColor", Vector) = (0.3867925,0.3867925,0.3867925,1)
		...
		_DissolveU ("DissolveU", Float) = 0
		_DissolveV ("DissolveV", Float) = 0
		...
		[Enum(UnityEngine.Rendering.CullMode)] _TiChu ("剔除模式", Float) = 0
